...
The currency of respect does cross group borders. That's what my father does. He earns respect below, then he transfers it upstairs. Talking about respect in fiscal terms makes sense, but it does require a different accounting practice. So how do I know who has it, and how much? 
I make up some rules to capture the idea: a) it should be obvious to an outside observer by watching the group dynamics, b) you can get things from your own group with it c) you can get things from other groups with it.
...
Phones are strategically placed around the factory, physical addresses describing this maze. The message is a catenation of location + person. If someone calls your name you would walk over to that phone’s location as someone needs help there. The most frequently called name is ‘Moti’, my father. A solid way to quantify respect is in the frequency of names called over the intercom. I secretly keep a notebook in my backpocket and scribble hash marks for each name/call pairing. That's a source of pride. He knows every bit of machinery. In fact, he's built or conceived most of them. 
